...
public class JdbcClientRunRepository {
    ...
    public Optional<Run> findById(Integer id) {
        return jdbcClient.sql("SELECT id, title, started_on, completed_on, miles, location FROM " +
                "Run WHERE id = :id")
                .param("id", id)
                .query(Run.class)
                .optional();
    ...
    public void create(Run run) {
        var updated = jdbcClient.sql("INSERT INTO Run(id, title, started_on, completed_on, miles," +
                " location) VALUES (?,?,?,?,?,?)")
